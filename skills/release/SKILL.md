...
- GitHub repo secrets: `LAUNCHPAD_GPG_PRIVATE_KEY` (`gpg --armor --export-secret-keys <KEYID>`), `LAUNCHPAD_GPG_PASSPHRASE`, `LAUNCHPAD_SSH_PRIVATE_KEY` (SFTP upload key), and `COPR_WEBHOOK` (Copr custom webhook base URL).
