...
| `sdme fs export` | Export a rootfs or container to a directory, tarball, or raw disk image |
...
| `src/export.rs` | Rootfs export (dir copy, tarball creation, raw ext4 disk image) |
