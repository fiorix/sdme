...
`--started` tells sdme to start the container immediately after creating it. Without it, you would need a separate `sdme start` command. `sdme new` combines create, start, and drops you into a shell.
